...
class CustomGateway implements SmsGatewayInterface {
    ...
    function __construct()
    {
        ...
        $this->param = Config::get('sms.custom.params.others');
    ...
    public function sendSms($mobile,$message)
    {
        ...
        $this->param[Config::get('sms.custom.params.send_to_name')] = $mobile;
        $this->param[Config::get('sms.custom.params.msg_name')] = $message;
